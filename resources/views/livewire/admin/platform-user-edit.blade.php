<div>
    <div class="mb-8 flex items-center space-x-3 text-sm text-text-tertiary">
        ...
        <span class="text-text-primary">Edit {{ $user->name }}</span>
    </div>
            ...
            <x-ui.card class="p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <x-ui.input id="name" type="text" wire:model="name" class="mt-1 w-full" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <x-ui.label for="password" value="Password (leave blank to keep current)" />
                            <x-ui.input id="password" type="password" wire:model="password" class="mt-1 w-full" autocomplete="new-password" />
                        ...
                        <div>
                            ...
                            <x-ui.input id="password_confirmation" type="password" wire:model="password_confirmation" class="mt-1 w-full" autocomplete="new-password" />
                        </div>
                    </div>
