<div>
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-text-primary tracking-tight">Add New Location</h1>
    </div>
            ...
            <form wire:submit="save">
                <div class="space-y-6">
                    <div>
                        ...
                        <x-ui.input id="name" type="text" wire:model="name" class="mt-1" placeholder="e.g. Downtown Branch" required autofocus />
                        @error('name')
                    ...
                    <div>
                        ...
                        <textarea id="address" wire:model="address" rows="3" class="flex w-full rounded-md border border-border-base bg-surface-1 px-3 py-2 text-sm placeholder:text-text-tertiary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal-500 focus-visible:border-signal-500 mt-1" placeholder="e.g. 123 Main St, City"></textarea>
                        @error('address')
                            <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-8 pt-6 border-t border-border-subtle flex items-center justify-end space-x-4">
                    ...
                    <x-ui.button type="submit">
                        ...
                        <span wire:loading.remove wire:target="save">Create Location</span>
