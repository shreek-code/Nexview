<div>
    <div class="mb-8">
        <div class="flex items-center space-x-3 text-sm text-text-tertiary mb-2">
            ...
            <span class="text-text-primary">Invite User</span>
        </div>
        <h1 class="text-2xl font-bold text-text-primary tracking-tight">Invite New Team Member</h1>
    </div>
        ...
        <div class="max-w-3xl space-y-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-ui.input id="password" type="password" wire:model="password" class="mt-1 block w-full" required autocomplete="new-password" />
                            @error('password')
                                <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-ui.input id="password_confirmation" type="password" wire:model="password_confirmation" class="mt-1 block w-full" required autocomplete="new-password" />
                        </div>
                    </div>
                </div>
            </x-ui.card>
            ...
            <div class="pt-6 border-t border-border-subtle flex items-center justify-end space-x-4">
                ...
                <x-ui.button type="submit">
                    ...
                    <span wire:loading.remove wire:target="save">Invite User</span>
                    <span wire:loading wire:target="save">Inviting...</span>
                </x-ui.button>
            </div>
        </div>
    </form>
