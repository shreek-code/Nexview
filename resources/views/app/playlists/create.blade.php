<x-layouts.app title="Create Playlist">
    <div class="mb-8">
    ...
    <form method="POST" action="{{ route('app.playlists.store') }}" x-data="{
        ...
        addMedia(mediaId) {
            ...
            if(media) {
                this.selectedItems.push({
                    ...
                    duration: media.type === 'image' ? 10 : 30 // default duration in seconds
                });
            }
        },
            ...
            <div class="xl:col-span-2 space-y-6">
                <x-ui.card class="p-6">
                    ...
                    <div>
                        ...
                        <x-ui.input id="name" type="text" name="name" class="mt-1" :value="old('name')" placeholder="e.g. Lobby Morning Loop" required autofocus />
                        @error('name')
