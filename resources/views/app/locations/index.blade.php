                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <x-ui.dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <form method="POST" action="{{ route('app.locations.destroy', $location) }}">
                                    @csrf
                                    @method('DELETE')
                                    <x-ui.dropdown-link as="button" type="submit" class="text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20" onclick="return confirm('Are you sure you want to delete this location?');">
                                        Delete
                                    </x-ui.dropdown-link>
                                </form>
                            </x-slot>
