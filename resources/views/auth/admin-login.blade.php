<x-layouts.guest>
    ...
    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-white tracking-tight">Admin Login</h1>
        <p class="text-white/60 text-sm mt-2">Platform administrator access</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.login') }}" class="space-y-6">
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-white/40">
                <a href="{{ route('login') }}" class="font-semibold text-purple-400 hover:text-purple-300 transition-colors">Back to user login</a>
            </p>
        </div>
    </form>
</x-layouts.guest>
